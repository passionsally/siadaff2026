(function () {
  const dictionaries = {
    en: {
      ...
      "장르와 기법을 자유롭게 표현한 3분 이내 단편애니메이션": "Short animation up to 3 minutes in any genre or technique",
      "2D, 3D, 스톱모션, 혼합기법 가능": "2D, 3D, stop-motion, and mixed techniques accepted",
      "극영화, 다큐멘터리, 실험영화 가능": "Fiction, documentary, and experimental films accepted",
      "포스터, 39초 광고, 59초 숏폼드라마, 3분 단편영화, 3분 단편애니메이션": "Poster, 39-sec Ad Film, 59-sec Short-form Drama, 3-min Short Film, 3-min Short Animation",
    ...
    "zh-CN": {
      ...
      "장르와 기법을 자유롭게 표현한 3분 이내 단편애니메이션": "题材与技法不限的3分钟以内短篇动画",
      "2D, 3D, 스톱모션, 혼합기법 가능": "接受2D、3D、定格动画及混合技法",
      "극영화, 다큐멘터리, 실험영화 가능": "接受剧情片、纪录片及实验电影",
      "포스터, 39초 광고, 59초 숏폼드라마, 3분 단편영화, 3분 단편애니메이션": "海报、39秒广告、59秒短剧、3分钟短片、3分钟短篇动画",
