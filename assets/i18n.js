(function () {
  const dictionaries = {
    en: {
      ...
      "단체출품 유의사항": "Organization Entry Requirements", "영상 기술 규격": "Video Specifications",
      ...
      "39초 이내 광고, 59초 이내 숏폼드라마, 3분 이내 단편영화, 3분 이내 단편애니메이션": "Ad Film up to 39 sec, Short-form Drama up to 59 sec, Short Film up to 3 min, Short Animation up to 3 min",
    ...
    "zh-CN": {
      ...
      "단체출품 유의사항": "团体参赛须知", "영상 기술 규격": "视频技术规格",
      ...
      "39초 이내 광고, 59초 이내 숏폼드라마, 3분 이내 단편영화, 3분 이내 단편애니메이션": "39秒以内广告、59秒以内短剧、3分钟以内短片、3分钟以内短篇动画",
