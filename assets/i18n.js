(function () {
  const dictionaries = {
    en: {
      ...
      "슈퍼얼리버드 8월 20일까지 30% 할인 적용": "30% Super Early Bird discount through August 20",
      ...
      "서울국제AI광고영화제 2026 출품 규정": "SIADAFF 2026 AI Submission Guidelines",
      ...
      "개인(청소년부) · 개인(성인부) · 단체(기업)": "Individual (Youth) · Individual (Adult) · Organization (Company)",
      "참가 구분": "Entry Division", "개인(청소년부), 개인(성인부), 단체(기업)": "Individual (Youth), Individual (Adult), Organization (Company)",
      ...
      "단체(기업)출품은 2026년 3월 28일 이전 개업한 사업자여야 합니다.": "Organization entries must be businesses established before March 28, 2026.",
      ...
      "서울국제AI광고영화제 2026": "Seoul International AI Advertising Art Film Festival 2026",
      ...
      "단체(기업)출품 유의사항": "Organization Entry Requirements", "영상 기술 규격": "Video Specifications",
      ...
      "총 24편 시상": "24 Works Awarded in Total",
      ...
      "사업자등록증 파일": "Business Registration Certificate", "AI 활용 여부": "Use of AI", "러닝타임": "Runtime",
      ...
      "개인출품 및 단체(기업)출품을 포함하여 본 대회에는 1개 작품만 출품할 수 있음을 확인했습니다.": "I confirm that I may submit only one work to this competition, whether as an individual or an organization.",
      "개인출품은 미기재 · 단체(기업)출품 선택 시 필수 입력": "Leave blank for individual entries · Required for organization entries",
      "개인출품은 미기재 · 단체(기업)출품 필수 · PDF, JPG, PNG · 최대 10MB": "Not required for individual entries · Required for organizations · PDF, JPG or PNG · Max. 10 MB",
      "개인출품이든 단체(기업)출품이든 본 대회에 1개 작품만 출품할 수 있습니다.": "Only one work may be submitted to this competition, whether as an individual or an organization.",
      ...
      "러닝타임, 제작 연도, 제작 형태, AI 활용 여부를 확인합니다.": "Runtime, production year, production format and AI use will be reviewed.",
      ...
      "수상작 및 출품작은 주최 측이 홍보용으로 상영, 게시, 편집 활용할 수 있습니다.": "The organizer may screen, publish and edit submitted or winning works for promotional purposes.",
      ...
      "심사 기준 100점 만점": "Judging criteria out of 100 points", "예: 39초": "e.g. 39 sec",
    ...
    "zh-CN": {
      ...
      "슈퍼얼리버드 8월 20일까지 30% 할인 적용": "超级早鸟优惠至8月20日，享受七折",
      ...
      "서울국제AI광고영화제 2026 출품 규정": "SIADAFF 2026 AI参赛规则",
      ...
      "개인(청소년부) · 개인(성인부) · 단체(기업)": "个人（青少年组）· 个人（成人组）· 团体（企业）",
      "참가 구분": "参赛组别", "개인(청소년부), 개인(성인부), 단체(기업)": "个人（青少年组）、个人（成人组）、团体（企业）",
      ...
      "단체(기업)출품은 2026년 3월 28일 이전 개업한 사업자여야 합니다.": "团体参赛者须为2026年3月28日前开业的企业。",
      "행사 개요": "电影节概况", "주최·주관·후원": "主办·承办·赞助",
      "행사명": "活动名称", "출품 대상": "参赛类别", "출품 주제": "参赛主题", "공식 언어": "官方语言", "해외 접수": "海外报名",
      "서울국제AI광고영화제 2026": "2026首尔国际AI广告电影节",
      ...
      "단체(기업)출품 유의사항": "团体参赛须知", "영상 기술 규격": "视频技术规格",
      ...
      "사업자등록증 파일": "营业执照文件", "AI 활용 여부": "是否使用AI", "러닝타임": "片长",
      ...
      "개인출품 및 단체(기업)출품을 포함하여 본 대회에는 1개 작품만 출품할 수 있음을 확인했습니다.": "我确认无论个人或团体参赛，本届比赛仅可提交一部作品。",
      "개인출품은 미기재 · 단체(기업)출품 선택 시 필수 입력": "个人参赛无需填写 · 选择团体参赛时必填",
      "개인출품은 미기재 · 단체(기업)출품 필수 · PDF, JPG, PNG · 최대 10MB": "个人参赛无需提交 · 团体参赛必填 · PDF、JPG、PNG · 最大10MB",
      "개인출품이든 단체(기업)출품이든 본 대회에 1개 작품만 출품할 수 있습니다.": "无论个人或团体参赛，本届比赛仅可提交一部作品。",
      ...
      "러닝타임, 제작 연도, 제작 형태, AI 활용 여부를 확인합니다.": "将核查片长、制作年份、制作形式及AI使用情况。",
      ...
      "수상작 및 출품작은 주최 측이 홍보용으로 상영, 게시, 편집 활용할 수 있습니다.": "主办方可为宣传目的放映、发布及编辑参赛作品和获奖作品。",
